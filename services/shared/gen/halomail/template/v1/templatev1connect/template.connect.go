...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/aashishrajdev/halomail/services/shared/gen/halomail/template/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	TemplateServiceName = "halomail.template.v1.TemplateService"
)
...
const (
	...
	// ListThemes RPC.
	TemplateServiceListThemesProcedure = "/halomail.template.v1.TemplateService/ListThemes"
	// TemplateServiceListTemplatesProcedure is the fully-qualified name of the TemplateService's
	// ListTemplates RPC.
	TemplateServiceListTemplatesProcedure = "/halomail.template.v1.TemplateService/ListTemplates"
	// TemplateServiceGetTemplateProcedure is the fully-qualified name of the TemplateService's
	// GetTemplate RPC.
	TemplateServiceGetTemplateProcedure = "/halomail.template.v1.TemplateService/GetTemplate"
	// TemplateServiceCreateTemplateProcedure is the fully-qualified name of the TemplateService's
	// CreateTemplate RPC.
	TemplateServiceCreateTemplateProcedure = "/halomail.template.v1.TemplateService/CreateTemplate"
	// TemplateServiceUpdateTemplateProcedure is the fully-qualified name of the TemplateService's
	// UpdateTemplate RPC.
	TemplateServiceUpdateTemplateProcedure = "/halomail.template.v1.TemplateService/UpdateTemplate"
	// TemplateServiceDeleteTemplateProcedure is the fully-qualified name of the TemplateService's
	// DeleteTemplate RPC.
	TemplateServiceDeleteTemplateProcedure = "/halomail.template.v1.TemplateService/DeleteTemplate"
	// TemplateServiceRenderPreviewProcedure is the fully-qualified name of the TemplateService's
	// RenderPreview RPC.
	TemplateServiceRenderPreviewProcedure = "/halomail.template.v1.TemplateService/RenderPreview"
)

// TemplateServiceClient is a client for the halomail.template.v1.TemplateService service.
...
// NewTemplateServiceClient constructs a client for the halomail.template.v1.TemplateService
...
func NewTemplateServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) TemplateServiceClient {
	...
	templateServiceMethods := v1.File_halomail_template_v1_template_proto.Services().ByName("TemplateService").Methods()
...
// ListThemes calls halomail.template.v1.TemplateService.ListThemes.
...
// ListTemplates calls halomail.template.v1.TemplateService.ListTemplates.
...
// GetTemplate calls halomail.template.v1.TemplateService.GetTemplate.
...
// CreateTemplate calls halomail.template.v1.TemplateService.CreateTemplate.
...
// UpdateTemplate calls halomail.template.v1.TemplateService.UpdateTemplate.
...
// DeleteTemplate calls halomail.template.v1.TemplateService.DeleteTemplate.
...
// RenderPreview calls halomail.template.v1.TemplateService.RenderPreview.
...
// TemplateServiceHandler is an implementation of the halomail.template.v1.TemplateService service.
...
func NewTemplateServiceHandler(svc TemplateServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/halomail.template.v1.TemplateService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedTemplateServiceHandler) ListThemes(context.Context, *connect.Request[v1.ListThemesRequest]) (*connect.Response[v1.ListThemesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halomail.template.v1.TemplateService.ListThemes is not implemented"))
}
...
func (UnimplementedTemplateServiceHandler) ListTemplates(context.Context, *connect.Request[v1.ListTemplatesRequest]) (*connect.Response[v1.ListTemplatesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halomail.template.v1.TemplateService.ListTemplates is not implemented"))
}
...
func (UnimplementedTemplateServiceHandler) GetTemplate(context.Context, *connect.Request[v1.GetTemplateRequest]) (*connect.Response[v1.GetTemplateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halomail.template.v1.TemplateService.GetTemplate is not implemented"))
}
...
func (UnimplementedTemplateServiceHandler) CreateTemplate(context.Context, *connect.Request[v1.CreateTemplateRequest]) (*connect.Response[v1.CreateTemplateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halomail.template.v1.TemplateService.CreateTemplate is not implemented"))
}
...
func (UnimplementedTemplateServiceHandler) UpdateTemplate(context.Context, *connect.Request[v1.UpdateTemplateRequest]) (*connect.Response[v1.UpdateTemplateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halomail.template.v1.TemplateService.UpdateTemplate is not implemented"))
}
...
func (UnimplementedTemplateServiceHandler) DeleteTemplate(context.Context, *connect.Request[v1.DeleteTemplateRequest]) (*connect.Response[v1.DeleteTemplateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halomail.template.v1.TemplateService.DeleteTemplate is not implemented"))
}
...
func (UnimplementedTemplateServiceHandler) RenderPreview(context.Context, *connect.Request[v1.RenderPreviewRequest]) (*connect.Response[v1.RenderPreviewResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halomail.template.v1.TemplateService.RenderPreview is not implemented"))
}
