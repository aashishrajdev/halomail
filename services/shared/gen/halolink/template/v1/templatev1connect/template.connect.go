...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/aashishrajdev/halomail/services/shared/gen/halolink/template/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	TemplateServiceName = "halolink.template.v1.TemplateService"
)
...
// period.
const (
	// TemplateServiceListThemesProcedure is the fully-qualified name of the TemplateService's
	// ListThemes RPC.
	TemplateServiceListThemesProcedure = "/halolink.template.v1.TemplateService/ListThemes"
	// TemplateServiceListTemplatesProcedure is the fully-qualified name of the TemplateService's
	// ListTemplates RPC.
	TemplateServiceListTemplatesProcedure = "/halolink.template.v1.TemplateService/ListTemplates"
	// TemplateServiceGetTemplateProcedure is the fully-qualified name of the TemplateService's
	// GetTemplate RPC.
	TemplateServiceGetTemplateProcedure = "/halolink.template.v1.TemplateService/GetTemplate"
	// TemplateServiceCreateTemplateProcedure is the fully-qualified name of the TemplateService's
	// CreateTemplate RPC.
	TemplateServiceCreateTemplateProcedure = "/halolink.template.v1.TemplateService/CreateTemplate"
	// TemplateServiceUpdateTemplateProcedure is the fully-qualified name of the TemplateService's
	// UpdateTemplate RPC.
	TemplateServiceUpdateTemplateProcedure = "/halolink.template.v1.TemplateService/UpdateTemplate"
	// TemplateServiceDeleteTemplateProcedure is the fully-qualified name of the TemplateService's
	// DeleteTemplate RPC.
	TemplateServiceDeleteTemplateProcedure = "/halolink.template.v1.TemplateService/DeleteTemplate"
	// TemplateServiceRenderPreviewProcedure is the fully-qualified name of the TemplateService's
	// RenderPreview RPC.
	TemplateServiceRenderPreviewProcedure = "/halolink.template.v1.TemplateService/RenderPreview"
)

// TemplateServiceClient is a client for the halolink.template.v1.TemplateService service.
type TemplateServiceClient interface {
	...
	RenderPreview(context.Context, *connect.Request[v1.RenderPreviewRequest]) (*connect.Response[v1.RenderPreviewResponse], error)
}

// NewTemplateServiceClient constructs a client for the halolink.template.v1.TemplateService
...
func NewTemplateServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) TemplateServiceClient {
	...
	templateServiceMethods := v1.File_halolink_template_v1_template_proto.Services().ByName("TemplateService").Methods()
	return &templateServiceClient{
		listThemes: connect.NewClient[v1.ListThemesRequest, v1.ListThemesResponse](
			httpClient,
			baseURL+TemplateServiceListThemesProcedure,
			connect.WithSchema(templateServiceMethods.ByName("ListThemes")),
		...
		renderPreview: connect.NewClient[v1.RenderPreviewRequest, v1.RenderPreviewResponse](
			httpClient,
			baseURL+TemplateServiceRenderPreviewProcedure,
			connect.WithSchema(templateServiceMethods.ByName("RenderPreview")),
			connect.WithClientOptions(opts...),
		),
	}
}
...
type templateServiceClient struct {
	...
	renderPreview  *connect.Client[v1.RenderPreviewRequest, v1.RenderPreviewResponse]
}

// ListThemes calls halolink.template.v1.TemplateService.ListThemes.
func (c *templateServiceClient) ListThemes(ctx context.Context, req *connect.Request[v1.ListThemesRequest]) (*connect.Response[v1.ListThemesResponse], error) {
	return c.listThemes.CallUnary(ctx, req)
}

// ListTemplates calls halolink.template.v1.TemplateService.ListTemplates.
...
// GetTemplate calls halolink.template.v1.TemplateService.GetTemplate.
...
// CreateTemplate calls halolink.template.v1.TemplateService.CreateTemplate.
...
// UpdateTemplate calls halolink.template.v1.TemplateService.UpdateTemplate.
...
// DeleteTemplate calls halolink.template.v1.TemplateService.DeleteTemplate.
...
// RenderPreview calls halolink.template.v1.TemplateService.RenderPreview.
func (c *templateServiceClient) RenderPreview(ctx context.Context, req *connect.Request[v1.RenderPreviewRequest]) (*connect.Response[v1.RenderPreviewResponse], error) {
	return c.renderPreview.CallUnary(ctx, req)
}

// TemplateServiceHandler is an implementation of the halolink.template.v1.TemplateService service.
...
func NewTemplateServiceHandler(svc TemplateServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	templateServiceMethods := v1.File_halolink_template_v1_template_proto.Services().ByName("TemplateService").Methods()
	templateServiceListThemesHandler := connect.NewUnaryHandler(
		TemplateServiceListThemesProcedure,
		svc.ListThemes,
		connect.WithSchema(templateServiceMethods.ByName("ListThemes")),
	...
	templateServiceRenderPreviewHandler := connect.NewUnaryHandler(
		TemplateServiceRenderPreviewProcedure,
		svc.RenderPreview,
		connect.WithSchema(templateServiceMethods.ByName("RenderPreview")),
		connect.WithHandlerOptions(opts...),
	)
	return "/halolink.template.v1.TemplateService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
		case TemplateServiceListThemesProcedure:
			templateServiceListThemesHandler.ServeHTTP(w, r)
		...
		case TemplateServiceRenderPreviewProcedure:
			templateServiceRenderPreviewHandler.ServeHTTP(w, r)
		default:
			http.NotFound(w, r)
		}
	})
...
func (UnimplementedTemplateServiceHandler) ListThemes(context.Context, *connect.Request[v1.ListThemesRequest]) (*connect.Response[v1.ListThemesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halolink.template.v1.TemplateService.ListThemes is not implemented"))
}
...
func (UnimplementedTemplateServiceHandler) ListTemplates(context.Context, *connect.Request[v1.ListTemplatesRequest]) (*connect.Response[v1.ListTemplatesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halolink.template.v1.TemplateService.ListTemplates is not implemented"))
}
...
func (UnimplementedTemplateServiceHandler) GetTemplate(context.Context, *connect.Request[v1.GetTemplateRequest]) (*connect.Response[v1.GetTemplateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halolink.template.v1.TemplateService.GetTemplate is not implemented"))
}
...
func (UnimplementedTemplateServiceHandler) CreateTemplate(context.Context, *connect.Request[v1.CreateTemplateRequest]) (*connect.Response[v1.CreateTemplateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halolink.template.v1.TemplateService.CreateTemplate is not implemented"))
}
...
func (UnimplementedTemplateServiceHandler) UpdateTemplate(context.Context, *connect.Request[v1.UpdateTemplateRequest]) (*connect.Response[v1.UpdateTemplateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halolink.template.v1.TemplateService.UpdateTemplate is not implemented"))
}
...
func (UnimplementedTemplateServiceHandler) DeleteTemplate(context.Context, *connect.Request[v1.DeleteTemplateRequest]) (*connect.Response[v1.DeleteTemplateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halolink.template.v1.TemplateService.DeleteTemplate is not implemented"))
}

func (UnimplementedTemplateServiceHandler) RenderPreview(context.Context, *connect.Request[v1.RenderPreviewRequest]) (*connect.Response[v1.RenderPreviewResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halolink.template.v1.TemplateService.RenderPreview is not implemented"))
}
