...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/aashishrajdev/halomail/services/shared/gen/halolink/contact/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	FormServiceName = "halolink.contact.v1.FormService"
	// MessageServiceName is the fully-qualified name of the MessageService service.
	MessageServiceName = "halolink.contact.v1.MessageService"
)
...
const (
	...
	FormServiceCreateFormProcedure = "/halolink.contact.v1.FormService/CreateForm"
	// FormServiceGetFormProcedure is the fully-qualified name of the FormService's GetForm RPC.
	FormServiceGetFormProcedure = "/halolink.contact.v1.FormService/GetForm"
	// FormServiceListFormsProcedure is the fully-qualified name of the FormService's ListForms RPC.
	FormServiceListFormsProcedure = "/halolink.contact.v1.FormService/ListForms"
	// FormServiceUpdateFormProcedure is the fully-qualified name of the FormService's UpdateForm RPC.
	FormServiceUpdateFormProcedure = "/halolink.contact.v1.FormService/UpdateForm"
	// FormServiceDeleteFormProcedure is the fully-qualified name of the FormService's DeleteForm RPC.
	FormServiceDeleteFormProcedure = "/halolink.contact.v1.FormService/DeleteForm"
	// MessageServiceSubmitMessageProcedure is the fully-qualified name of the MessageService's
	// SubmitMessage RPC.
	MessageServiceSubmitMessageProcedure = "/halolink.contact.v1.MessageService/SubmitMessage"
	// MessageServiceListMessagesProcedure is the fully-qualified name of the MessageService's
	// ListMessages RPC.
	MessageServiceListMessagesProcedure = "/halolink.contact.v1.MessageService/ListMessages"
	// MessageServiceGetMessageProcedure is the fully-qualified name of the MessageService's GetMessage
	// RPC.
	MessageServiceGetMessageProcedure = "/halolink.contact.v1.MessageService/GetMessage"
	// MessageServiceMarkReadProcedure is the fully-qualified name of the MessageService's MarkRead RPC.
	MessageServiceMarkReadProcedure = "/halolink.contact.v1.MessageService/MarkRead"
	// MessageServiceDeleteMessageProcedure is the fully-qualified name of the MessageService's
	// DeleteMessage RPC.
	MessageServiceDeleteMessageProcedure = "/halolink.contact.v1.MessageService/DeleteMessage"
)

// FormServiceClient is a client for the halolink.contact.v1.FormService service.
...
// NewFormServiceClient constructs a client for the halolink.contact.v1.FormService service. By
...
func NewFormServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) FormServiceClient {
	...
	formServiceMethods := v1.File_halolink_contact_v1_contact_proto.Services().ByName("FormService").Methods()
...
// CreateForm calls halolink.contact.v1.FormService.CreateForm.
...
// GetForm calls halolink.contact.v1.FormService.GetForm.
...
// ListForms calls halolink.contact.v1.FormService.ListForms.
...
// UpdateForm calls halolink.contact.v1.FormService.UpdateForm.
...
// DeleteForm calls halolink.contact.v1.FormService.DeleteForm.
...
// FormServiceHandler is an implementation of the halolink.contact.v1.FormService service.
...
func NewFormServiceHandler(svc FormServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/halolink.contact.v1.FormService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedFormServiceHandler) CreateForm(context.Context, *connect.Request[v1.CreateFormRequest]) (*connect.Response[v1.CreateFormResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halolink.contact.v1.FormService.CreateForm is not implemented"))
}
...
func (UnimplementedFormServiceHandler) GetForm(context.Context, *connect.Request[v1.GetFormRequest]) (*connect.Response[v1.GetFormResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halolink.contact.v1.FormService.GetForm is not implemented"))
}
...
func (UnimplementedFormServiceHandler) ListForms(context.Context, *connect.Request[v1.ListFormsRequest]) (*connect.Response[v1.ListFormsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halolink.contact.v1.FormService.ListForms is not implemented"))
}
...
func (UnimplementedFormServiceHandler) UpdateForm(context.Context, *connect.Request[v1.UpdateFormRequest]) (*connect.Response[v1.UpdateFormResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halolink.contact.v1.FormService.UpdateForm is not implemented"))
}
...
func (UnimplementedFormServiceHandler) DeleteForm(context.Context, *connect.Request[v1.DeleteFormRequest]) (*connect.Response[v1.DeleteFormResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halolink.contact.v1.FormService.DeleteForm is not implemented"))
}

// MessageServiceClient is a client for the halolink.contact.v1.MessageService service.
...
// NewMessageServiceClient constructs a client for the halolink.contact.v1.MessageService service.
...
func NewMessageServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) MessageServiceClient {
	baseURL = strings.TrimRight(baseURL, "/")
	messageServiceMethods := v1.File_halolink_contact_v1_contact_proto.Services().ByName("MessageService").Methods()
...
// SubmitMessage calls halolink.contact.v1.MessageService.SubmitMessage.
...
// ListMessages calls halolink.contact.v1.MessageService.ListMessages.
...
// GetMessage calls halolink.contact.v1.MessageService.GetMessage.
...
// MarkRead calls halolink.contact.v1.MessageService.MarkRead.
...
// DeleteMessage calls halolink.contact.v1.MessageService.DeleteMessage.
...
// MessageServiceHandler is an implementation of the halolink.contact.v1.MessageService service.
...
func NewMessageServiceHandler(svc MessageServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/halolink.contact.v1.MessageService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedMessageServiceHandler) SubmitMessage(context.Context, *connect.Request[v1.SubmitMessageRequest]) (*connect.Response[v1.SubmitMessageResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halolink.contact.v1.MessageService.SubmitMessage is not implemented"))
}
...
func (UnimplementedMessageServiceHandler) ListMessages(context.Context, *connect.Request[v1.ListMessagesRequest]) (*connect.Response[v1.ListMessagesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halolink.contact.v1.MessageService.ListMessages is not implemented"))
}
...
func (UnimplementedMessageServiceHandler) GetMessage(context.Context, *connect.Request[v1.GetMessageRequest]) (*connect.Response[v1.GetMessageResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halolink.contact.v1.MessageService.GetMessage is not implemented"))
}
...
func (UnimplementedMessageServiceHandler) MarkRead(context.Context, *connect.Request[v1.MarkReadRequest]) (*connect.Response[v1.MarkReadResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halolink.contact.v1.MessageService.MarkRead is not implemented"))
}
...
func (UnimplementedMessageServiceHandler) DeleteMessage(context.Context, *connect.Request[v1.DeleteMessageRequest]) (*connect.Response[v1.DeleteMessageResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halolink.contact.v1.MessageService.DeleteMessage is not implemented"))
}
