...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/aashishrajdev/halomail/services/shared/gen/halolink/notification/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	EmailServiceName = "halolink.notification.v1.EmailService"
	// WebhookServiceName is the fully-qualified name of the WebhookService service.
	WebhookServiceName = "halolink.notification.v1.WebhookService"
)
...
const (
	...
	EmailServiceSendEmailProcedure = "/halolink.notification.v1.EmailService/SendEmail"
	// WebhookServiceCreateWebhookProcedure is the fully-qualified name of the WebhookService's
	// CreateWebhook RPC.
	WebhookServiceCreateWebhookProcedure = "/halolink.notification.v1.WebhookService/CreateWebhook"
	// WebhookServiceListWebhooksProcedure is the fully-qualified name of the WebhookService's
	// ListWebhooks RPC.
	WebhookServiceListWebhooksProcedure = "/halolink.notification.v1.WebhookService/ListWebhooks"
	// WebhookServiceDeleteWebhookProcedure is the fully-qualified name of the WebhookService's
	// DeleteWebhook RPC.
	WebhookServiceDeleteWebhookProcedure = "/halolink.notification.v1.WebhookService/DeleteWebhook"
	// WebhookServiceRotateSecretProcedure is the fully-qualified name of the WebhookService's
	// RotateSecret RPC.
	WebhookServiceRotateSecretProcedure = "/halolink.notification.v1.WebhookService/RotateSecret"
	// WebhookServiceDispatchProcedure is the fully-qualified name of the WebhookService's Dispatch RPC.
	WebhookServiceDispatchProcedure = "/halolink.notification.v1.WebhookService/Dispatch"
)

// EmailServiceClient is a client for the halolink.notification.v1.EmailService service.
type EmailServiceClient interface {
	SendEmail(context.Context, *connect.Request[v1.SendEmailRequest]) (*connect.Response[v1.SendEmailResponse], error)
}

// NewEmailServiceClient constructs a client for the halolink.notification.v1.EmailService service.
...
func NewEmailServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) EmailServiceClient {
	...
	emailServiceMethods := v1.File_halolink_notification_v1_notification_proto.Services().ByName("EmailService").Methods()
...
// SendEmail calls halolink.notification.v1.EmailService.SendEmail.
...
// EmailServiceHandler is an implementation of the halolink.notification.v1.EmailService service.
...
func NewEmailServiceHandler(svc EmailServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/halolink.notification.v1.EmailService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedEmailServiceHandler) SendEmail(context.Context, *connect.Request[v1.SendEmailRequest]) (*connect.Response[v1.SendEmailResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halolink.notification.v1.EmailService.SendEmail is not implemented"))
}

// WebhookServiceClient is a client for the halolink.notification.v1.WebhookService service.
...
// NewWebhookServiceClient constructs a client for the halolink.notification.v1.WebhookService
...
func NewWebhookServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) WebhookServiceClient {
	baseURL = strings.TrimRight(baseURL, "/")
	webhookServiceMethods := v1.File_halolink_notification_v1_notification_proto.Services().ByName("WebhookService").Methods()
...
// CreateWebhook calls halolink.notification.v1.WebhookService.CreateWebhook.
...
// ListWebhooks calls halolink.notification.v1.WebhookService.ListWebhooks.
...
// DeleteWebhook calls halolink.notification.v1.WebhookService.DeleteWebhook.
...
// RotateSecret calls halolink.notification.v1.WebhookService.RotateSecret.
...
// Dispatch calls halolink.notification.v1.WebhookService.Dispatch.
...
// WebhookServiceHandler is an implementation of the halolink.notification.v1.WebhookService
// service.
...
func NewWebhookServiceHandler(svc WebhookServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/halolink.notification.v1.WebhookService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedWebhookServiceHandler) CreateWebhook(context.Context, *connect.Request[v1.CreateWebhookRequest]) (*connect.Response[v1.CreateWebhookResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halolink.notification.v1.WebhookService.CreateWebhook is not implemented"))
}
...
func (UnimplementedWebhookServiceHandler) ListWebhooks(context.Context, *connect.Request[v1.ListWebhooksRequest]) (*connect.Response[v1.ListWebhooksResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halolink.notification.v1.WebhookService.ListWebhooks is not implemented"))
}
...
func (UnimplementedWebhookServiceHandler) DeleteWebhook(context.Context, *connect.Request[v1.DeleteWebhookRequest]) (*connect.Response[v1.DeleteWebhookResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halolink.notification.v1.WebhookService.DeleteWebhook is not implemented"))
}
...
func (UnimplementedWebhookServiceHandler) RotateSecret(context.Context, *connect.Request[v1.RotateSecretRequest]) (*connect.Response[v1.RotateSecretResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halolink.notification.v1.WebhookService.RotateSecret is not implemented"))
}
...
func (UnimplementedWebhookServiceHandler) Dispatch(context.Context, *connect.Request[v1.DispatchRequest]) (*connect.Response[v1.DispatchResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halolink.notification.v1.WebhookService.Dispatch is not implemented"))
}
