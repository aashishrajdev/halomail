...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/aashishrajdev/halomail/services/shared/gen/halolink/identity/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	AuthServiceName = "halolink.identity.v1.AuthService"
	// UserServiceName is the fully-qualified name of the UserService service.
	UserServiceName = "halolink.identity.v1.UserService"
	// ApiKeyServiceName is the fully-qualified name of the ApiKeyService service.
	ApiKeyServiceName = "halolink.identity.v1.ApiKeyService"
	// AuditServiceName is the fully-qualified name of the AuditService service.
	AuditServiceName = "halolink.identity.v1.AuditService"
)
...
const (
	...
	AuthServiceRegisterProcedure = "/halolink.identity.v1.AuthService/Register"
	// AuthServiceLoginProcedure is the fully-qualified name of the AuthService's Login RPC.
	AuthServiceLoginProcedure = "/halolink.identity.v1.AuthService/Login"
	// AuthServiceLogoutProcedure is the fully-qualified name of the AuthService's Logout RPC.
	AuthServiceLogoutProcedure = "/halolink.identity.v1.AuthService/Logout"
	// AuthServiceRefreshSessionProcedure is the fully-qualified name of the AuthService's
	// RefreshSession RPC.
	AuthServiceRefreshSessionProcedure = "/halolink.identity.v1.AuthService/RefreshSession"
	// AuthServiceGetCurrentUserProcedure is the fully-qualified name of the AuthService's
	// GetCurrentUser RPC.
	AuthServiceGetCurrentUserProcedure = "/halolink.identity.v1.AuthService/GetCurrentUser"
	// AuthServiceVerifyTokenProcedure is the fully-qualified name of the AuthService's VerifyToken RPC.
	AuthServiceVerifyTokenProcedure = "/halolink.identity.v1.AuthService/VerifyToken"
	// UserServiceGetUserProcedure is the fully-qualified name of the UserService's GetUser RPC.
	UserServiceGetUserProcedure = "/halolink.identity.v1.UserService/GetUser"
	// UserServiceGetUserByHandleProcedure is the fully-qualified name of the UserService's
	// GetUserByHandle RPC.
	UserServiceGetUserByHandleProcedure = "/halolink.identity.v1.UserService/GetUserByHandle"
	// UserServiceUpdateUserProcedure is the fully-qualified name of the UserService's UpdateUser RPC.
	UserServiceUpdateUserProcedure = "/halolink.identity.v1.UserService/UpdateUser"
	// ApiKeyServiceCreateApiKeyProcedure is the fully-qualified name of the ApiKeyService's
	// CreateApiKey RPC.
	ApiKeyServiceCreateApiKeyProcedure = "/halolink.identity.v1.ApiKeyService/CreateApiKey"
	// ApiKeyServiceListApiKeysProcedure is the fully-qualified name of the ApiKeyService's ListApiKeys
	// RPC.
	ApiKeyServiceListApiKeysProcedure = "/halolink.identity.v1.ApiKeyService/ListApiKeys"
	// ApiKeyServiceRevokeApiKeyProcedure is the fully-qualified name of the ApiKeyService's
	// RevokeApiKey RPC.
	ApiKeyServiceRevokeApiKeyProcedure = "/halolink.identity.v1.ApiKeyService/RevokeApiKey"
	// ApiKeyServiceVerifyApiKeyProcedure is the fully-qualified name of the ApiKeyService's
	// VerifyApiKey RPC.
	ApiKeyServiceVerifyApiKeyProcedure = "/halolink.identity.v1.ApiKeyService/VerifyApiKey"
	// AuditServiceListAuditLogsProcedure is the fully-qualified name of the AuditService's
	// ListAuditLogs RPC.
	AuditServiceListAuditLogsProcedure = "/halolink.identity.v1.AuditService/ListAuditLogs"
	// AuditServiceRecordAuditLogProcedure is the fully-qualified name of the AuditService's
	// RecordAuditLog RPC.
	AuditServiceRecordAuditLogProcedure = "/halolink.identity.v1.AuditService/RecordAuditLog"
)

// AuthServiceClient is a client for the halolink.identity.v1.AuthService service.
...
// NewAuthServiceClient constructs a client for the halolink.identity.v1.AuthService service. By
...
func NewAuthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AuthServiceClient {
	...
	authServiceMethods := v1.File_halolink_identity_v1_identity_proto.Services().ByName("AuthService").Methods()
...
// Register calls halolink.identity.v1.AuthService.Register.
...
// Login calls halolink.identity.v1.AuthService.Login.
func (c *authServiceClient) Login(ctx context.Context, req *connect.Request[v1.LoginRequest]) (*connect.Response[v1.LoginResponse], error) {
	return c.login.CallUnary(ctx, req)
}

// Logout calls halolink.identity.v1.AuthService.Logout.
...
// RefreshSession calls halolink.identity.v1.AuthService.RefreshSession.
...
// GetCurrentUser calls halolink.identity.v1.AuthService.GetCurrentUser.
...
// VerifyToken calls halolink.identity.v1.AuthService.VerifyToken.
...
// AuthServiceHandler is an implementation of the halolink.identity.v1.AuthService service.
...
func NewAuthServiceHandler(svc AuthServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/halolink.identity.v1.AuthService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAuthServiceHandler) Register(context.Context, *connect.Request[v1.RegisterRequest]) (*connect.Response[v1.RegisterResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halolink.identity.v1.AuthService.Register is not implemented"))
}

func (UnimplementedAuthServiceHandler) Login(context.Context, *connect.Request[v1.LoginRequest]) (*connect.Response[v1.LoginResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halolink.identity.v1.AuthService.Login is not implemented"))
}

func (UnimplementedAuthServiceHandler) Logout(context.Context, *connect.Request[v1.LogoutRequest]) (*connect.Response[v1.LogoutResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halolink.identity.v1.AuthService.Logout is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) RefreshSession(context.Context, *connect.Request[v1.RefreshSessionRequest]) (*connect.Response[v1.RefreshSessionResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halolink.identity.v1.AuthService.RefreshSession is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) GetCurrentUser(context.Context, *connect.Request[v1.GetCurrentUserRequest]) (*connect.Response[v1.GetCurrentUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halolink.identity.v1.AuthService.GetCurrentUser is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) VerifyToken(context.Context, *connect.Request[v1.VerifyTokenRequest]) (*connect.Response[v1.VerifyTokenResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halolink.identity.v1.AuthService.VerifyToken is not implemented"))
}

// UserServiceClient is a client for the halolink.identity.v1.UserService service.
...
// NewUserServiceClient constructs a client for the halolink.identity.v1.UserService service. By
// default, it uses the Connect protocol with the binary Protobuf Codec, asks for gzipped responses,
// and sends uncompressed requests. To use the gRPC or gRPC-Web protocols, supply the
// connect.WithGRPC() or connect.WithGRPCWeb() options.
//
...
func NewUserServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) UserServiceClient {
	baseURL = strings.TrimRight(baseURL, "/")
	userServiceMethods := v1.File_halolink_identity_v1_identity_proto.Services().ByName("UserService").Methods()
...
// GetUser calls halolink.identity.v1.UserService.GetUser.
...
// GetUserByHandle calls halolink.identity.v1.UserService.GetUserByHandle.
...
// UpdateUser calls halolink.identity.v1.UserService.UpdateUser.
...
// UserServiceHandler is an implementation of the halolink.identity.v1.UserService service.
...
func NewUserServiceHandler(svc UserServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/halolink.identity.v1.UserService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedUserServiceHandler) GetUser(context.Context, *connect.Request[v1.GetUserRequest]) (*connect.Response[v1.GetUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halolink.identity.v1.UserService.GetUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) GetUserByHandle(context.Context, *connect.Request[v1.GetUserByHandleRequest]) (*connect.Response[v1.GetUserByHandleResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halolink.identity.v1.UserService.GetUserByHandle is not implemented"))
}
...
func (UnimplementedUserServiceHandler) UpdateUser(context.Context, *connect.Request[v1.UpdateUserRequest]) (*connect.Response[v1.UpdateUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halolink.identity.v1.UserService.UpdateUser is not implemented"))
}

// ApiKeyServiceClient is a client for the halolink.identity.v1.ApiKeyService service.
...
// NewApiKeyServiceClient constructs a client for the halolink.identity.v1.ApiKeyService service. By
// default, it uses the Connect protocol with the binary Protobuf Codec, asks for gzipped responses,
// and sends uncompressed requests. To use the gRPC or gRPC-Web protocols, supply the
// connect.WithGRPC() or connect.WithGRPCWeb() options.
//
...
func NewApiKeyServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ApiKeyServiceClient {
	baseURL = strings.TrimRight(baseURL, "/")
	apiKeyServiceMethods := v1.File_halolink_identity_v1_identity_proto.Services().ByName("ApiKeyService").Methods()
...
// CreateApiKey calls halolink.identity.v1.ApiKeyService.CreateApiKey.
...
// ListApiKeys calls halolink.identity.v1.ApiKeyService.ListApiKeys.
...
// RevokeApiKey calls halolink.identity.v1.ApiKeyService.RevokeApiKey.
...
// VerifyApiKey calls halolink.identity.v1.ApiKeyService.VerifyApiKey.
...
// ApiKeyServiceHandler is an implementation of the halolink.identity.v1.ApiKeyService service.
...
func NewApiKeyServiceHandler(svc ApiKeyServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/halolink.identity.v1.ApiKeyService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedApiKeyServiceHandler) CreateApiKey(context.Context, *connect.Request[v1.CreateApiKeyRequest]) (*connect.Response[v1.CreateApiKeyResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halolink.identity.v1.ApiKeyService.CreateApiKey is not implemented"))
}
...
func (UnimplementedApiKeyServiceHandler) ListApiKeys(context.Context, *connect.Request[v1.ListApiKeysRequest]) (*connect.Response[v1.ListApiKeysResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halolink.identity.v1.ApiKeyService.ListApiKeys is not implemented"))
}
...
func (UnimplementedApiKeyServiceHandler) RevokeApiKey(context.Context, *connect.Request[v1.RevokeApiKeyRequest]) (*connect.Response[v1.RevokeApiKeyResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halolink.identity.v1.ApiKeyService.RevokeApiKey is not implemented"))
}
...
func (UnimplementedApiKeyServiceHandler) VerifyApiKey(context.Context, *connect.Request[v1.VerifyApiKeyRequest]) (*connect.Response[v1.VerifyApiKeyResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halolink.identity.v1.ApiKeyService.VerifyApiKey is not implemented"))
}

// AuditServiceClient is a client for the halolink.identity.v1.AuditService service.
...
// NewAuditServiceClient constructs a client for the halolink.identity.v1.AuditService service. By
// default, it uses the Connect protocol with the binary Protobuf Codec, asks for gzipped responses,
// and sends uncompressed requests. To use the gRPC or gRPC-Web protocols, supply the
// connect.WithGRPC() or connect.WithGRPCWeb() options.
//
...
func NewAuditServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AuditServiceClient {
	baseURL = strings.TrimRight(baseURL, "/")
	auditServiceMethods := v1.File_halolink_identity_v1_identity_proto.Services().ByName("AuditService").Methods()
...
// ListAuditLogs calls halolink.identity.v1.AuditService.ListAuditLogs.
...
// RecordAuditLog calls halolink.identity.v1.AuditService.RecordAuditLog.
...
// AuditServiceHandler is an implementation of the halolink.identity.v1.AuditService service.
...
func NewAuditServiceHandler(svc AuditServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/halolink.identity.v1.AuditService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAuditServiceHandler) ListAuditLogs(context.Context, *connect.Request[v1.ListAuditLogsRequest]) (*connect.Response[v1.ListAuditLogsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halolink.identity.v1.AuditService.ListAuditLogs is not implemented"))
}
...
func (UnimplementedAuditServiceHandler) RecordAuditLog(context.Context, *connect.Request[v1.RecordAuditLogRequest]) (*connect.Response[v1.RecordAuditLogResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("halolink.identity.v1.AuditService.RecordAuditLog is not implemented"))
}
